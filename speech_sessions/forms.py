...
class SpeechSessionCreateForm(forms.ModelForm):
    ...
    class Meta:
        model = SpeechSession
        fields = ['duration', 'audio_file', 'transcription']
        widgets = {
        ...
        help_texts = {
            'duration': 'Enter the duration of your speech session in seconds.',
            'audio_file': 'Upload an audio file (MP3, WAV, M4A, OGG, or FLAC format).',
